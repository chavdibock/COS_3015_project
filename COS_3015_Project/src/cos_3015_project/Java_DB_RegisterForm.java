...
public final class Java_DB_RegisterForm extends javax.swing.JFrame {
                ...
                .addGroup(pnl_welcomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnl_welcomeLayout.createSequentialGroup()
                        ...
                        .addGroup(pnl_welcomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_confirmPass, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)))
                    .addGroup(pnl_welcomeLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    public static boolean isValidUserName(String userName) {
        try {
            ...
            if (conn != null) {
                ...
                String query = "SELECT user_salt, user_hash FROM " + credentials.getTable() + " ;";
    ...
    private void bthn_regActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bthn_regActionPerformed
        ...
        if (pass.equals(repeatPAss)) {
            ...
            if (isValidUserName(name) == true) {
                ...
                try {
                    Cred credentials = new Cred();
                    String algorithm = credentials.getAlgo();
                    ...
                    try {
                        ...
                        if (conn != null) {
                            ...
                            String insert = "Insert into " + credentials.getTable() + " (user_salt,user_hash,pass_salt,pass) values ('"
                                    + strSaltUser + "','"
                                    + hashUser + "','"
                                    + strSaltPass + "','"
                                    + hashPass
    ...
    private void chb_show_passActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chb_show_passActionPerformed
        if (chb_show_pass.isSelected()) {
            ...
            txt_confirmPass.setEchoChar((char) 0);// Show password
        } else {
            txt_Pass.setEchoChar('*'); // Hide password
            txt_confirmPass.setEchoChar('*');// Hide password
        }
